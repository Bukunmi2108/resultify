export {default as HomePage} from './all/HomePage'
...
export {default as AdminFeed} from './admin/AdminFeed'
...
export {default as AllAdmin} from './admin/AllAdmin'
export {default as UploadResult} from './admin/UploadResult'
export {default as ViewStudentResult} from './admin/ViewStudentResult'
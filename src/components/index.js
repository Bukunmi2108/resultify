...
export { default as ProfileMiniDetails } from './molecules/ProfileMiniDetails'
export { default as AdminFeedMiniDisplay } from './molecules/AdminFeedMiniDisplay'
export { default as SideLink } from './molecules/SideLink'


export { default as Navbar } from './organisms/Navbar'
export { default as Nav } from './organisms/Nav'
export { default as AdminCon } from './organisms/AdminCon'
...
export { default as Addsubjecttemplate } from './templates/Addsubjecttemplate'
...
export { default as Alladmintemplate } from './templates/Alladmintemplate'

export { default as Uploadresulttemplate } from './templates/Uploadresulttemplate'
export { default as Viewstudentresulttemplate } from './templates/Viewstudentresulttemplate'